			 ...
			 <div class="fashion-section">
				 <div class="fashion-grid1">
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/m4.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/m2.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/m3.jpg" alt=""/>
				 ...
				 <div class="fashion-grid2">
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/m1.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img class="img-responsive zoom-img" src="{{url('public')}}/images/m6.jpg" alt=""/>
							 <div class="product not-avaliable">
								 <h3>PRODUCT NAME</h3>
								 <p><del><span></span> 176.00 &euro;</del></p>
							 </div>
					 ...
					 <div class="col-md-4 fashion-grid">
						 <a href="single.html"><img src="{{url('public')}}/images/m5.jpg" alt=""/>
							 <div class="product">
								 <h3>PRODUCT NAME</h3>
								 <p><span></span> 176.00 &euro;</p>
							 </div>
