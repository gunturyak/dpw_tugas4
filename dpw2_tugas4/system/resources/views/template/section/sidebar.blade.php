...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">MYSHOOP</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Guntur Pamungkas</a>
        </div>
      </div>
        ...
        <li class="nav-item">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('suplayer')}}" class="nav-link {{checkRouteActive('suplayer')}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Suplayer</p>
                </a>
              </li>
